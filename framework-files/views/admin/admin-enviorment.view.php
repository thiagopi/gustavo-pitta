...
<section id="enviorment" class="content-out admin">
                ...
                <table class="tbl-pictures">
                    ...
                    <tbody class="sortable">
                        ...
                        <tr class="single-wrapper" data-position="{{ $key }}">
                            <td>
                                <figure><img src="{{ assets('images/portfolio/ambiente-e-decoracao/'.$value['s_file']) }}" alt="{{ $value['s_text1'] }}" draggable="false" /></figure>
                            </td>
                            <td>
