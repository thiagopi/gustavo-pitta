...
<section id="cover" class="content-out internal still">
...
<section class="content-out menu-categories">
    ...
    <div class="btn btn-blue rounded">Still</div>
...
<section id="gastronomia" class="content-out category">
    <div class="content-in">
        <div class="wrapper">
            @foreach($arr as $pic)
            <div class="cat">
                <img src="{{ assets('/') }}images/portfolio/still/{{ $pic['s_file'] }}" alt="{{ $pic['s_text1'] }}" />
                @if($pic['s_text1'] !== "")
                <h3>{{ $pic['s_text1'] }}</h3>
                @endif
            </div>
        ...
        <div class="btn-group center">
            <div class="btn btn-blue rounded btn-loadMore" onClick="loadMore(3)">Carregar mais</div>
        </div>
