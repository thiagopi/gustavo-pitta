...
<section id="cover" class="content-out internal portrait">
...
<section class="content-out menu-categories">
    ...
    <div class="btn btn-blue rounded">Retratos</div>
    <a href="{{ base_url() }}moda-beleza" class="btn btn-white btn-outline rounded">Moda & Beleza</a>
...
<section id="portrait" class="content-out category">
    <div class="content-in">
        <div class="wrapper">
            @foreach($arr as $pic)
            <div class="cat">
                <img src="{{ assets('/') }}images/portfolio/retratos/{{ $pic['s_file'] }}" alt="{{ $pic['s_text1'] }}" />
                @if($pic['s_text1'] !== "")
                <h3>{{ $pic['s_text1'] }}</h3>
                @endif
            </div>
        ...
        <div class="btn-group center">
            <div class="btn btn-blue rounded btn-loadMore" onClick="loadMore(4)">Carregar mais</div>
        </div>
