...
class AdminStillController extends Controller
{

    public static function viewAdminStill(){
        LoginMiddleware::handle();
        //
        $blade = new BladeOne();
        //
        $arr = PortfolioModel::getPictures(3);
        $idx = 0;
        foreach($arr as $a) {
        ...
        //
        return $blade->run('admin.admin-still', compact('arr'));
    }
}