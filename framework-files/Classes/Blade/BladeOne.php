...
/**
 * Class BladeOne
 * @package  Classes\BladeOne
 * @author   Jorge Patricio Castro Castillo <jcastro arroba eftec dot cl>
 * @author   Thiago Pereira Idehama
 * @changed  default compiled path => /storage/framework/views
 * @version  3.27 2019-05-25
 * @version  1.1.1 2019-12-10
...
{    //<editor-fold desc="fields">
    ...
    protected $fileExtension = '.view.php';
     ...
     */
    public function __construct($templatePath=null, $compiledPath=null,$mode=5)
    {
        if ($templatePath===null) $templatePath=getcwd(). '/framework-files/views';
        if ($compiledPath===null) $compiledPath=getcwd() . '/framework-files/storage/framework/views';
    ...
    public function setPath($templatePath,$compiledPath) {
	    if ($templatePath===null) $templatePath=getcwd(). '/framework-files/views';
	    if ($compiledPath===null) $compiledPath=getcwd() . '/framework-files/compiles';
	    $this->templatePath=$templatePath;
        $this->compiledPath=$compiledPath;
    }
    ...
    public function run($view, $variables = [])
    {
        ...
        return print_r($this->runInternal($view, $variables, $forced, true, $runFast));
    }
    ...
    private function locateTemplate($name){
        // $this->dump($this->templatePath, true);
    ...
    public function getFile($fileName)
    {
        ...
        if (is_file($fileName)){
            ...
            return $this->showError('getFile', "File does not exist at path {$fileName}", true);
        }
